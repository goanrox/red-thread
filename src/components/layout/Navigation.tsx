    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-[#2a2a45]">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <span className="font-serif text-xl text-parchment tracking-wider group-hover:text-gold transition-colors duration-200">
            Red Thread
          </span>
          <span
            className="hidden sm:block h-px w-6 opacity-50 group-hover:opacity-100 transition-opacity duration-200"
